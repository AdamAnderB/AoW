...
\begin{figure}[h]
    ...
    \caption{The four black boxes are surrounding the visual stimuli- The center image is not part of the visual stimuli}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figures/Gorilla_work_flow.png}
    \caption{Gorilla Work Flow}
    \label{fig:Gorilla_work_flow.png}
\end{figure}
