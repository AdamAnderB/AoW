...
Results from the GLMER found significant effect in the \inlineR{verbtype}-Restricting ($\beta$ = 0.28076, SE = 0.069, z = 2.35, p < .05), tone ($\beta$ = .99, SE = .43, z = 4.192, p < .001), indicating more looks to targets for restricting items over non-restricted items. Additionally, an interaction between speaker and verb type ($\beta$ = -0.13737, SE = 0.05346, z = -2.570, p<.05). 
