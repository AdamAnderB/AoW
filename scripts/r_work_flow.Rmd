...
eyetracking_data_select <- file.choose()
eyetracking_data<-read.csv(eyetracking_data_select,header=TRUE, row.names=1)
OSF_data_select <- file.choose()
OSF_data<-read.csv(OSF_data,
